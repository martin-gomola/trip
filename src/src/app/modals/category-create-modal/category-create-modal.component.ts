...
export class CategoryCreateModalComponent {
  ...
  iconOptions: CategoryIconOption[] = [
    ...
    { label: 'Map folded', value: 'map', icon: faMap },
    { label: 'Location', value: 'location-dot', icon: faLocationDot },
    { label: 'Compass', value: 'compass', icon: faCompass },
    { label: 'Signpost', value: 'signs-post', icon: faSignsPost },
    { label: 'Passport', value: 'passport', icon: faPassport },
    { label: 'Suitcase', value: 'suitcase', icon: faSuitcase },
    { label: 'Luggage', value: 'suitcase-rolling', icon: faSuitcaseRolling },
    { label: 'Globe', value: 'globe', icon: faGlobe },
    { label: 'Europe', value: 'earth-europe', icon: faEarthEurope },
    { label: 'Road', value: 'road', icon: faRoad },
    { label: 'Bridge', value: 'bridge', icon: faBridge },
    { label: 'Archway', value: 'archway', icon: faArchway },
    { label: 'Monument', value: 'monument', icon: faMonument },
    { label: 'Tent', value: 'tent', icon: faTent },
    { label: 'Campfire', value: 'fire', icon: faFire },
    { label: 'Fuel', value: 'gas-pump', icon: faGasPump },
    { label: 'Restroom', value: 'restroom', icon: faRestroom },
    { label: 'Toilet', value: 'toilet', icon: faToilet },
    { label: 'Medical', value: 'hospital', icon: faHospital },
